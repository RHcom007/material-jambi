...
<body class="hold-transition sidebar-mini layout-fixed">
                            ...
                            <div class="card card-primary">
                                ...
                                <form method='post' action='process.php'>
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="harga">Nama Harga Barang</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="deskripsisingkat" placeholder="Masukkan Deskripsi Singkat" name='deskripsi_singkat'>
                                        </div>
                                        <div class="form-group">
    ...
    <script>
        ...
        var myDropzone = new Dropzone(document.body, { // Make the whole body a dropzone
            url: "gambar_upload.php", // Set the url
            thumbnailWidth: 80,
            thumbnailHeight: 80,
            parallelUploads: 20,
