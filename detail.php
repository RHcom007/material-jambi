        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <h3 class="font-weight-semi-bold mb-4">Rp <?= $product['harga'] ?></h3>
                    <p class="mb-4"><?= $product['deskripsi_singkat'] ?></p>
                    <!-- <div class="d-flex mb-3">
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        ...
                        <a target="_blank" href='https://wa.me/62895391177774?text=<?= $product['nama_barang'] ?>%0A<?= $product['deskripsi_singkat'] ?>%0A<?= $product['harga'] ?>' class="btn btn-primary px-3"><i class="fa fa-shopping-cart mr-1"></i> Pesan sekarang</a>
                    </div>
